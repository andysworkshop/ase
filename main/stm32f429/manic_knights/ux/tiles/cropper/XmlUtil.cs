...
namespace cropper
{
	 ...
	 */
		...
		public static Int32 GetInt(XmlNode parent_,string xpath_,Int32 default_,bool required_)
		{
			string str;
	 ...
	 */
		...
		public static bool GetBool(XmlNode parent_,string xpath_,bool default_,bool required_)
		{
			string str;
